<?php
class Model_izin_tata_usaha extends CI_Model
{	
    ...
    public function init_delete()
    {
        ...
        $this->mydb1->delete('izin_tata_usaha');
    ...
    {
        $query = $this->mydb1->query("SELECT count(id) as exist FROM izin_tata_usaha WHERE id = '$id'");
        $cek = $query->row();
