<p><?php $CI =& get_instance();  echo $this->session->flashdata('pesan'); ?></p>
    ...
    <form class="form-horizontal" method="POST" action="<?php echo site_url('category/add'); ?>">
            ...
            <label class="col-md-2 control-label" for="textinput">Title</label>
                <div class="col-md-6">
                    <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                        <input type="text" class="form-control" name="title" id="title" placeholder="Title" title="Title" value="<?php echo $this->session->flashdata('title_category'); ?>">
                    </div>
              </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-xs-offset-2 col-xs-10">
                ...
                <a href="<?php echo site_url('category'); ?>" class="btn btn-primary">Back</a>
            </div>
        </div>
