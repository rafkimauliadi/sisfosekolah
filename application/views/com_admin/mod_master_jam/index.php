<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Master Jam</h4>
            <p><?php echo $this->session->flashdata('pesan'); ?></p>
            <h6 class="card-subtitle"></h6>
            <a title="Tambah Data" href="<?php echo site_url('master-jam/add')?>" class="btn btn-primary btn-rounded m-t-10 float-right"><i class="fa fa-plus"></i> Add</a>
                    ...
                    <tbody id="data_mobil">
                        ...
                        <tr>
                            ...
                            <td>
															...
															<a href="<?php echo site_url('master_jam/edit/'.$row->id); ?>" class="button-edit btn btn-info btn-rounded"><i class="fa fa-edit"></i> Edit</a>
														</td>
                        </tr>
											<?php }?>
                    </tbody>
	...
	$(function() {
		...
		$(".button-delete").click(function () {
				...
				Swal.fire({
						...
						if (result.value) {
							window.location.href = "<?php echo site_url(); ?>master-jam/delete/"+id_mapel;
						}
				})
		});
