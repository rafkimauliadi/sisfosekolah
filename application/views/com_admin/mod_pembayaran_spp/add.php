      ...
      <form class="form-horizontal" method="POST" action="<?php echo site_url('pembayaran-spp/add'); ?>">
          ...
          <div class="form-group">
              <label class="col-md-2 control-label" for="textinput">Kelas</label>
                  <div class="col-md-6">
                      <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                          <input type="text" class="form-control" name="id_kelas" id="id_kelas" placeholder="Kelas" title="id_kelas" value="<?php echo $this->session->flashdata('id_kelas'); ?>">
                      </div>
                </div>
          </div>
          ...
          <div class="form-group">
              <label class="col-md-2 control-label" for="textinput">Uang SPP</label>
                  <div class="col-md-6">
                      <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                          <input type="text" class="form-control" name="total_bayar" id="total_bayar" placeholder="800000 (Rupiah)" title="total_bayar" value="<?php echo $this->session->flashdata('total_bayar'); ?>">
                      </div>
                </div>
          </div>
