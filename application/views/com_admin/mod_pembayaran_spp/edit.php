      ...
      <form class="form-horizontal" method="POST" action="<?php echo site_url('pembayaran-spp/edit'); ?>">
          ...
          <div class="form-group">
              <label class="col-md-2 control-label" for="textinput">Biaya SPP</label>
                  <div class="col-md-6">
                      <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                          <input type="text" class="form-control" name="jumlah_spp" id="jumlah_spp" placeholder="Biaya SPP" title="jumlah_spp" value="<?php echo $details->row()->jumlah_spp; ?>">
                      </div>
                </div>
          </div>
          ...
          <div class="form-group">
              <label class="col-md-2 control-label" for="textinput">Status Pembayaran</label>
                  <div class="col-md-6">
                      <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                          <input type="text" class="form-control" name="status_bayar" id="status_bayar" placeholder="Status Pembayaran" title="status_bayar" value="<?php echo $details->row()->status_bayar; ?>">
                      </div>
                </div>
          </div>
          ...
          <div class="form-group">
              <label class="col-md-2 control-label" for="textinput">Bukti Pembayaran</label>
                  <div class="col-md-6">
                      <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase"></span></span>
                          <input type="text" class="form-control" name="bukti_pembayaran" id="bukti_pembayaran" placeholder="Bukti Pembayaran" title="bukti_pembayaran" value="<?php echo $details->row()->bukti_pembayaran; ?>">
                      </div>
                </div>
          </div>
