...
<div class="page-header">
       <a title="Tambah Data" href="<?php echo site_url('user/add')?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
</div>   

<div class="page-header">
    <form class="form-inline" method="POST" action="<?php echo site_url('user/search'); ?>" >
    ...
    <a href="<?php echo site_url('user')?>" ><i class="fa fa-refresh"></i> Refresh</a>
    </form>   
</div>                        
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="confirm-edit" href="<?php echo site_url('user/edit/'.$row->id_user); ?>">Edit</a>
                                </li>

                                <li>
                                    <a class="confirm-edit" href="<?php echo site_url('user/view/'.$row->id_user); ?>">View Data</a>
                                </li>

                                <li>
                                    <a class="confirm-delete" href="<?php echo site_url('user/delete/'.$row->id_user); ?>">Delete</a>
                                </li>
                            </ul>
                        </div>
                    </td>
