<div class="col-12">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Tambahkan Nilai Siswa</h4>
      <p><?php $CI =& get_instance();  echo $this->session->flashdata('pesan'); ?></p>

      <form class="form-horizontal" method="POST" action="<?php echo site_url('nilai-siswa/add'); ?>">
...
<div class="col-md-6">
    ...
    <label class="control-label">Nilai Siswa</label>
                                <input type="text" id="nilai_siswa" name="nilai_siswa" class="form-control" placeholder="nilai_siswa" value="<?php echo $this->session->flashdata('nilai_siswa'); ?>">
                            </div>
</div>
</div>
