<article>
    <h3><i class="fa fa-search"></i> Keyword Pencarian Anda : <span class="label label-danger arrowed"><?php echo $search; ?></span></h3>
    
    <?php
    foreach ($init_searching->result() as $row) :
        ...
        <div class="row">
          <div class="col text-center small p-2">
            <p>
              ...
              | <i class="fa fa-tags"></i> Tags : <a href="#"><span class="badge badge-info"><?php echo $row->title_category; ?></span></a>
            </p>
          </div>
        </div>
      </div>
    ...
    <?php
    $init_searching->free_result(); endforeach;
    
    ?>
    <hr/>
    <?php 
        if ($init_searching->row()==NULL)
    {
