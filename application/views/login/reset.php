        ...
        <div class="row">
			...
			<div class="col-md-4">
              <h4 class="">
                ...
                <form accept-charset="UTF-8" role="form" id="login-recordar" method="post" action="<?php echo site_url('reset/akun'); ?>">
                  <fieldset>
                    ...
                    <div class="form-group input-group">
                      ...
                      <input class="form-control" placeholder="Email" name="email" type="email" value="<?php echo $this->session->flashdata('email'); ?>" >
                    </div>
