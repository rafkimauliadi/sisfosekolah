        ...
        <div class="row">
			...
			<div class="col-md-4">
              <h4 class="">
                ...
                <?php $token = $this->format_data->string($this->uri->segment(3,0)); ?>
                <form accept-charset="UTF-8" role="form" id="login-recordar" method="post" action="<?php echo site_url('reset/password/'.$token); ?>">
                  <fieldset>
                    ...
                    <div class="form-group input-group">
                      ...
                      <input class="form-control" placeholder="New Password" name="password" type="password" value="<?php echo $this->session->flashdata('password'); ?>" >
                    </div>
                    <button type="submit" class="btn btn-primary btn-block" id="btn-olvidado" name="submit">
                      Continue
                    </button>
                    <br/>
                  </fieldset>
